...
*/
console.log(createMenuItem('Burger','$25','Cheese-Burger'));
console.log(createMenuItem('Pizza','$35','Cheese-Pizza'));
console.log(createMenuItem('Ice-cream','$45','Strawberry'));
...
*/
// reviews.push({name: "Rimsha", rating: 2.5, feedback: "Too expensive menu"}),
...
*/
 ...
 function getReviewByRating(array,num) {
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].rating === num && array[i].rating <= num +1){
      newArr.push(array[i]);
